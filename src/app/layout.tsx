...
export const metadata: Metadata = {
  ...
  title: {
      default: "Новий порох | Товари для військових - РЕБ індивідульний, Електронна розтяжка, Індикатор поверхневого підриву, Ініціатор підриву за зміною магнітного поля",
